function [gridness, Props] = gridprops_legacy(autoCorr,varargin)
...
if p.Results.getellgridness
    ...
    if ~isnan(abScale)
        ...
        [tmp, Props]            = scanpix.analysis.gridprops_legacy(autoCorrReg,true,'zscorethr',p.Results.zscorethr,'getprops',getGridProps,'getellgridness',false,'plot',p.Results.plot,'ax',axArr(3),'props',Props);
...
peakStats              = regionprops(peaksAutoCorr,autoCorr, 'WeightedCentroid','EquivDiameter','MajorAxisLength','MinorAxisLength','Area');
%
